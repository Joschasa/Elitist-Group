...
function ElitistGroup:GetItemColor(itemLevel)
	local quality = itemLevel >= 355 and ITEM_QUALITY_EPIC or itemLevel >= 325 and ITEM_QUALITY_RARE or itemLevel >= 295 and ITEM_QUALITY_UNCOMMON or ITEM_QUALITY_COMMON
